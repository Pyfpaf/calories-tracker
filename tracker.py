...
def find_closest_food(product: str, available: List[str]) -> Optional[str]:
    ...
    special_rules = {
        ...
        'протеинового батончика': 'протеиновый батончик',
        'протеиновый батончик': 'протеиновый батончик',
        'батончик': 'протеиновый батончик',
        'батончика': 'протеиновый батончик',
        # Овощной салат
        'овощного салата': 'овощной салат',
        'овощной салат': 'овощной салат',
        'салат овощной': 'овощной салат',
        # Пицца и синонимы
        'пиццы': 'пицца',
        'пицца': 'пицца',
        # Супы
        'овощного супа': 'овощной суп',
